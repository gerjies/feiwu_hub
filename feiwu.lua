...
local Window = OrionLib:MakeWindow({Name = "飞舞脚本", HidePremium = false, SaveConfig = true,IntroText = "正在加载", ConfigFolder = "232323232"})
...
脚本
        ...
        game.Players.LocalPlayer:Kick("这里是卡密错误踢出时显示的字")
    end
end)
